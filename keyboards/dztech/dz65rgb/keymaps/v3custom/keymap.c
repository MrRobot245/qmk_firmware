...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_65_ansi(
        ...
        KC_LCTL, LM(1, MOD_LALT),  KC_LGUI,                            KC_SPC,                             KC_RGUI,MO(1), MO(1),   KC_LEFT, KC_DOWN, KC_RGHT  \
    ),
        [1] = LAYOUT_65_ansi(
        ...
        _______, _______, _______, _______, _______, QK_BOOTLOADER, _______, KC_MAIL, _______, _______, _______, _______,          KC_VOLU, _______, \
